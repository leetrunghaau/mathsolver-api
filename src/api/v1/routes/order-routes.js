...
router.post('/admin/orders',authorization(['admin']) , OrderController.adminGetAllOrder);
router.get('/admin/order/:status',authorization(['admin']), OrderValidate.adminGetOrdersByStatus , OrderController.adminGetAllOrderByStatus);
router.put('/admin/order',authorization(['admin']), OrderValidate.adminUpdateStatus , OrderController.checkOut);
